...
const hospitalBedsByRequestedTimeEst = (data) => {
  ...
  const bedAvailabilityInHospitals = 0.35 * totalHospitalBeds;
...
const casesForICUByRequestedTimeEst = () => {
  impact.casesForICUByRequestedTime = Math.trunc(0.02 * impact.infectionsByRequestedTime);
  severeImpact.casesForICUByRequestedTime = Math.trunc(0.02 * severeImpact.infectionsByRequestedTime);
};
